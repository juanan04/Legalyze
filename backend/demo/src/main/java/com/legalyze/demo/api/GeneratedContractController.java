...
public class GeneratedContractController {
     ...
     * 
     * @PostMapping("/ai")
     * public ResponseEntity<com.legalyze.demo.dto.GenerateAiContractResponse>
     * generateAi(
     * 
     ...
     * 
     * @GetMapping("/{id}")
     * public ResponseEntity<GenerateContractResponse> getById(@PathVariable Long
     * id) {
     ...
     * headers.setContentDispositionFormData("attachment", "contrato-" + id +
     * ".docx");
     * 
